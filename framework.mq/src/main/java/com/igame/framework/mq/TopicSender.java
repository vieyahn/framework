 ...
 * @Description:Use in conjunction with TopicListener to test the performance of ActiveMQ
 * Topics.
 * @Version V1.0
 */
public class TopicSender {
	...
	private TopicSender(String user, String password, String url, String subject)
			throws Exception {
